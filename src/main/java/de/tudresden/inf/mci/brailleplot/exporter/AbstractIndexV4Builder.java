 ...
 * from the Index Printer Interface Protocol V5_V4 2ß16-05-13. All the Variables with the respective Values have no
 * particular order (except mStartTemporaryDoc, which must be at the beginning). All the Variable Names are set to
 * final, these are Printer specific Values that should not be changed.
